...
<section id ="main">
		<div class="subimg">
			<ul>
				<li><img src="<c:url value="/"/>image/sampleamcbook.jpg" alt="samplemacbook"></li>
				<li><img src="<c:url value="/"/>image/samplemacbook2.jpg" alt="samplemacbook2"></li>
				<li><img src="<c:url value="/"/>image/samplemacbook3.jpg" alt="samplemacbook3"></li>
				<li><img src="<c:url value="/"/>image/samplemacbook4.jpg" alt="samplemacbook4"></li>
			</ul>
		</div>
		<div class="mainimg">
